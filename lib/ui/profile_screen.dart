     ...
     child:Column(
      children:[
       ...
       Container(
        ...
        padding:const EdgeInsets.all(16),
        decoration:BoxDecoration(color:Colors.white,borderRadius:BorderRadius.circular(20),border:Border.all(color:ThemeApp.mauVien)),
        child:Row(
 ...
 Widget _nutChon(String text,bool chon,VoidCallback onTap){
  return InkWell(
   ...
   child:Container(
    ...
    child:Center(child:Text(text,style:TextStyle(color:chon?Colors.white:ThemeApp.mauChinh,fontWeight:FontWeight.bold))),
   ),
  );
 }
}
