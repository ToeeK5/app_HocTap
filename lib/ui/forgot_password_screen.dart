        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const Text(
                "Nhap tai khoan va email de doi mat khau",
              ...
              TextField(
                ...
                decoration: oNhap("Nhap tai khoan hoac ma sinh vien", Icons.person_rounded),
              ),
              const SizedBox(height: 16),
              TextField(
                controller: emailController,
                keyboardType: TextInputType.emailAddress,
                decoration: oNhap("Nhap email", Icons.email_rounded),
              ),
              const SizedBox(height: 30),
              SizedBox(
